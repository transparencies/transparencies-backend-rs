...
impl<'input, 'output> Serializer<'input, 'output> {
    fn new(urlencoder: &'output mut UrlEncodedSerializer<'input, String>)
           -> Self {
...
impl Error {
    ...
    fn top_level_not_supported() -> Self {
        Error::TopLevelNotSupported { location: std::panic::Location::caller() }
    }

    #[track_caller]
    fn field_not_supported() -> Self {
        Error::FieldNotSupported { location: std::panic::Location::caller() }
    }

    #[track_caller]
    fn pair_not_supported() -> Self {
        Error::PairNotSupported { location: std::panic::Location::caller() }
    }

    #[track_caller]
    fn value_not_supported() -> Self {
        Error::ValueNotSupported { location: std::panic::Location::caller() }
    }
}
...
impl<'input, 'output> ser::Serializer for Serializer<'input, 'output> {
    ...
    fn serialize_map(self,
        ...
        Ok(MapSerializer { urlencoder: self.urlencoder })
    }
    ...
    fn serialize_i8(self,
                    _v: i8)
                    -> Result<Self::Ok, Self::Error> {
        Err(Error::top_level_not_supported())
    }

    fn serialize_i16(self,
                     _v: i16)
                     -> Result<Self::Ok, Self::Error> {
        Err(Error::top_level_not_supported())
    }

    fn serialize_i32(self,
                     _v: i32)
                     -> Result<Self::Ok, Self::Error> {
        Err(Error::top_level_not_supported())
    }
    ...
    fn serialize_u8(self,
                    _v: u8)
                    -> Result<Self::Ok, Self::Error> {
        Err(Error::top_level_not_supported())
    }

    fn serialize_u16(self,
                     _v: u16)
                     -> Result<Self::Ok, Self::Error> {
        Err(Error::top_level_not_supported())
    }

    fn serialize_u32(self,
                     _v: u32)
                     -> Result<Self::Ok, Self::Error> {
        Err(Error::top_level_not_supported())
    }

    fn serialize_u64(self,
                     _v: u64)
                     -> Result<Self::Ok, Self::Error> {
        Err(Error::top_level_not_supported())
    }

    fn serialize_f32(self,
                     _v: f32)
                     -> Result<Self::Ok, Self::Error> {
        Err(Error::top_level_not_supported())
    }

    fn serialize_f64(self,
                     _v: f64)
                     -> Result<Self::Ok, Self::Error> {
        Err(Error::top_level_not_supported())
    }
    ...
    fn serialize_str(self,
                     _v: &str)
                     -> Result<Self::Ok, Self::Error> {
        Err(Error::top_level_not_supported())
    }

    fn serialize_bytes(self,
                       _v: &[u8])
                       -> Result<Self::Ok, Self::Error> {
        Err(Error::top_level_not_supported())
    }
...
impl<'input, 'output> ser::SerializeMap for MapSerializer<'input, 'output> {
    ...
    {
        self.urlencoder
            .append_pair(&key.serialize(ValueSerializer)?,
                         &value.serialize(ValueSerializer)?);
        Ok(())
    }

    fn serialize_key<T: ?Sized>(&mut self,
                                _key: &T)
                                -> Result<(), Self::Error>
        where T: serde::Serialize,
    {
...
impl<'input, 'output> ser::SerializeStruct
    for StructSerializer<'input, 'output>
{
    type Error = Error;
    type Ok = &'output mut UrlEncodedSerializer<'input, String>;
    ...
    fn serialize_field<T: ?Sized>(&mut self,
        ...
        where T: serde::Serialize,
    {
        value.serialize(FieldSerializer { key,
...
impl<'input, 'output> ser::Serializer for FieldSerializer<'input, 'output> {
    ...
    fn serialize_str(self,
        ...
        value.serialize(PairSerializer { key: self.key,
                                         urlencoder: self.urlencoder })?;
        Ok(self.urlencoder)
    }
    ...
    fn serialize_unit_variant(self,
                              ...
                              variant: &'static str)
                              -> Result<Self::Ok, Self::Error> {
        variant.serialize(PairSerializer { key: self.key,
                                           urlencoder: self.urlencoder })?;
        Ok(self.urlencoder)
    }
...
fn serialize_query() {
    ...
    let req = Request { filter: "1".to_string(),
                        maybe: None,
                        possibly: Some(("sure thing".to_string(),)),
                        ids: vec![Some("2".to_string()),
                                  Some("3".to_string())],
                        ids2: vec![4],
                        stuff: (32, -35f32, "ha"),
                        extras: [(1i32, "one"), (2, "two")].iter()
                                                           .copied()
                                                           .collect(),
                        username: String::from("justintv"),
                        variant: Variant::Hello,
                        variant2: Some(Variant::World),
                        num: 123 };
    assert_eq!(to_string(req).unwrap(),
