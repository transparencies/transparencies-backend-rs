...
/// Query Parameters for [Get Rating History](super::get_rating_history)
///
/// [`rating_history`](https://aoe2.net/#api)
// TODO
...
#[derive(PartialEq,
           ...
           Debug)]
#[non_exhaustive]
pub struct GetRatingHistoryRequest<'a> {
    /// ID of the channel
...
impl<'a> GetRatingHistoryRequest<'a> {
    pub fn new(game: &'a str,
        ...
        GetRatingHistoryRequest::builder().game(game)
...
impl<'a> Request for GetRatingHistoryRequest<'a> {
    ...
    const PATH: &'static str = "player/ratinghistory";
    const ROOT: &'static str = crate::AOE2_NET_URL;
}

impl<'a> RequestGet for GetRatingHistoryRequest<'a> {
    fn parse_response(
        request: Option<Self>,
        uri: &http::Uri,
